                        ...
                        <form method="POST" action="{{ route('register.account') }}">
                            ...
                            <div class="my-8 hidden animate-blink " id="RegisterForm">
                                ...
                                <div class="max-w-sm space-y-3">
                                    ...
                                    <div class="relative">
                                        <input type="password" id="register_password" name="password" class="peer py-3 px-4 ps-4 block w-full bg-[#E5E5E5] border-transparent rounded-[12px] text-sm dark:bg-[#E5E5E5] dark:border-transparent dark:text-black dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Enter Password">
                                        <div class="absolute inset-y-0 start-0 flex items-center ps-4">

                                        </div>
                                    </div>
                                    <div class="relative">
                                        <input type="password" form="password_confirmation" name="password_confirmation" class="peer py-3 px-4 ps-4 block w-full bg-[#E5E5E5] border-transparent rounded-[12px] text-sm dark:bg-[#E5E5E5] dark:border-transparent dark:text-black dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Re-enter Password">
                                        <div class="absolute inset-y-0 start-0 flex items-center ps-4">
