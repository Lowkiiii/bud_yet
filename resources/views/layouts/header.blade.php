<div class="z-50 relative w-auto mx-auto justify-center items-center  xl:w-[92rem]">
    <div class=" border-b border-[#244C53] sk p-4 w-full relative text-[#05D9FF] flex sm:hidden">
        <img src="/image/BY-WHITE.png" class="h-5" alt="">
        <span class="px-4">Dashboard</span>
    </div>
    <div
        class="fixed w-full items-center justify-center mx-auto bottom-0 p-4 sm:hidden bg-[#1B1B1B] border-t border-[#244C53]">
