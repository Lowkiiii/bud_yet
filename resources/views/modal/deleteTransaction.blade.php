            ...
            <div class="sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                <div
                    ...
                    <div class="px-8 py-3 mt-2 text-white sk overflow-y-auto">
                        Are you sure you want to <span class="text-red-500 sk-bold">Delete</span> the Transaction?
                    </div>
                    <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t border-[#4C4C4C]">
                        ...
                        <button type="button"
                            class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-700 disabled:opacity-50 disabled:pointer-events-none sk-bold">
                            Yes Delete!
                        </button>
                    </div>
                </div>
