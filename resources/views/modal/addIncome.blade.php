                ...
                <form action="{{ route('income.store') }}" method="POST" class="mt-2">
                    ...
                    <div class="relative">
                        <input type="text" name="income_name" id="income_name"
                            ...
                            autofill:pb-2"
                            placeholder="">
                        <label for="hs-floating-underline-input-email"
                            class="sk absolute top-0 start-0 py-4 px-0 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                              peer-focus:scale-90
                              ...
                              peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500 sk">Income
                            Name</label>
                    </div>
                    <div class="relative">
                    ...
                    <div
                        class="text-xs flex-col flex font-semibold  items-start justify-start sk truncate text-white  w-full mt-2 ">

                        <input type="date"
                            class="py-4 sk bg-[#2B2B2B] rounded-lg text-white outline-none px-4 pe-2 block w-full text-sm border-b border-[#4C4C4C] disabled:opacity-50 disabled:pointer-events-none dark:border-transparent dark:text-neutral-400 hide-calendar-icon"
                            id="date" name="date" placeholder="Start Date" />
